      ...
      nodes: {
        ...
        items: {
          ...
          properties: {
            ...
            readRoots: { type: 'array', items: { type: 'string' }, description: 'Extra read roots for this node (same semantics as `agent` tool readRoots).' },
            writeRoots: { type: 'array', items: { type: 'string' }, description: 'Extra write roots for this node (same semantics as `agent` tool writeRoots).' },
